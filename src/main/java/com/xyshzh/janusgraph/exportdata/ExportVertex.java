...
public class ExportVertex {
  public static void main(String[] args) {
    ...
    com.xyshzh.janusgraph.datasource.WriterFile writer = new com.xyshzh.janusgraph.datasource.WriterFile("./V.txt");
    ...
    try {
      org.apache.tinkerpop.gremlin.process.traversal.dsl.graph.GraphTraversal<org.apache.tinkerpop.gremlin.structure.Vertex, org.apache.tinkerpop.gremlin.structure.Vertex> vs = g.V(); // 获取所有节点信息
      try {
